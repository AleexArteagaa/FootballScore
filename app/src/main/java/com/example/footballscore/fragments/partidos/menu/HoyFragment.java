...
public class HoyFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        RecyclerView recyclerView = rootView.findViewById(R.id.recyclerViewTabbedHoy);
        ...
        Call<PartidosResponse> call = apiService.getPartidosPorDia(getFechaHoy());
    ...
    public String getFechaHoy(){
        ...
        String fechaPartidos = new SimpleDateFormat("yyyy-MM-dd").format(hoy.getTime());
