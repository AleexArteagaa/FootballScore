...
public class MananaFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_manana, container, false);

        System.out.println("MAÑANA");

        RecyclerView recyclerView = rootView.findViewById(R.id.recyclerViewTabbedManana);
        ...
        Call<PartidosResponse> call = apiService.getPartidosPorDia(getFechaManana());
    ...
    public String getFechaManana(){
        ...
        String fechaPartidos = new SimpleDateFormat("yyyy-MM-dd").format(mañana.getTime());
